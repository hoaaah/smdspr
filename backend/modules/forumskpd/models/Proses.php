...
class Proses extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['kd_urusan', 'kd_bidang', 'kd_unit', 'kd_sub', 'tahun', 'input_phased'], 'unique', 'targetAttribute' => ['kd_urusan', 'kd_bidang', 'kd_unit', 'kd_sub', 'tahun', 'input_phased'], 'message' => 'Berita Acara untuk tahun tersebut sudah ada.'],
