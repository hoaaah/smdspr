...
class RenjaKegiatanSearch extends RenjaKegiatan
{
    ...
    public function search($params)
    {
        ...
        $query->orderBy('a.kd_urusan', 'a.kd_bidang', 'a.kd_unit', 'a.kd_sub', 'a.id_renprog')  ;    
        ...
        IF(isset($this->kd_sub) && $this->kd_sub <> NULL){
            list($this->kd_urusan, $this->kd_bidang, $this->kd_unit, $this->kd_sub, $this->no_skpdMisi, $this->no_skpdTujuan, $this->no_skpdSasaran, $this->no_renjaSas, $this->no_renjaProg, $this->id_renprog) = explode('.', $this->kd_sub);
        }            
