        ...
        'columns' => [
            ...
            [
                ...
                'value'=> function($model){
                    if($model->status == 1){
                        return Html::a('Belum Diproses', ['praproses', 'id' => $model->id], ['class' => 'label label-primary','data' => ['confirm' => 'Yakin akan memproses data?'],]);
                    }ELSE{
                        return Html::a('Telah Diproses', '#', ['class' => 'label label-danger']);
                    }
                }
