...
$this->params['breadcrumbs'][] = ['label' => 'Forum SKPD', 'url' => ['subkegiatan/index']];
...
<div class="proses-index">
    ...
    <p>
        <?= Html::a('Tambah Berita Acara', ['createforum'], ['class' => 'btn btn-sm btn-success']) ?>
    </p>
        ...
        'columns' => [
            ...
            [
                ...
                'value'=> function($model){
                    if($model->status == 1){
                        return Html::a('Belum Diproses', ['praprosesforum', 'id' => $model->id], ['class' => 'btn btn-xs btn-primary','data' => ['confirm' => 'Yakin akan memproses data?'],]);
                    }ELSE{
