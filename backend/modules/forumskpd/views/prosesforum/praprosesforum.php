...
$this->params['breadcrumbs'][] = ['label' => 'Forum SKPD', 'url' => ['renjakegiatanforum/index']];
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title"><?= "Dinas ".Yii::$app->user->identity->tperan->sub->Nm_Sub_Unit ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <?= GridView::widget([
                        ...
                        'responsive'=>true,
                        'hover'=>true,
                        'panel'=>['type'=>'primary', 'heading'=>'Daftar Usulan Diterima pada BA ini.'.Html::a('<i class="fa fa-check"></i>Proses Data', ['prosesforum', 'id' => $model->id], ['class' => 'btn btn-xs btn-danger pull-right','data' => ['confirm' => 'Proses Data?', 'method' => 'post']])
                        ],                        
