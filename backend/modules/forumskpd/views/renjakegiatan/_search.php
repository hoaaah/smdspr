...
<div class="renja-kegiatan-search">
    ...
    <div class="col-sm-6">
        <?php $data = ArrayHelper::map($query, 'kd_program','uraian');
        echo $form->field($model, 'kd_sub')->widget(Select2::classname(), [
            'data' => $data,
            'options' => ['placeholder' => 'Cari Program...'],
            'pluginOptions' => [
                'allowClear' => true
            ],
        ])->label(false);
    ...
    <div class="col-sm-6">
        <?php  echo $form->field($model, 'uraian' )->input('uraian', ['placeholder' => "Cari Kegiatan..."])->label(false); ?>
    </div>
