                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">                    
                                ...
                                <?php  echo $form->field($model, 'kd_kelurahan')->widget(DepDrop::classname(), [
                                                'options'=>['id'=>'subkegiatan-kd_kelurahan'],
                                                'pluginOptions'=>[
                                                    'depends'=>['subkegiatan-kd_kecamatan'],
                                                    'placeholder'=>'Pilih Kelurahan/Desa',
                                                    'url'=>Url::to(['subkelurahan'])
                                                ]
                                            ]); ?>
