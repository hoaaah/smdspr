...
?>
<button type="button" class="add btn btn-info btn-xs"><i class="glyphicon glyphicon-plus"></i></button>
...
<?php $this->registerJs("
        $('#subkegiatan-form').yiiActiveForm('add', {
            'id': 'subkegiatan',
            'name': 'subkegiatan',
            'container': '.field-subkegiatan',
            'input': '#subkegiatan',
            'error': '.field-subkegiatan .help-block'
        });
    ");
