...
// $pdf->Cell(180,6,'MUSRENBANG DESA/KELURAHAN',0,0,'C');
// $pdf->Ln();
// $pdf->SetFont('Times','B',12); 
// $pdf->Cell(180,6,'KABUPATEN SIMULASI',0,0,'C');
// $pdf->Ln();
// $pdf->SetFont('Times','BU',12); 
// $pdf->Cell(180,6,Yii::$app->user->identity->tperan->kd_kelurahan <> NULL ? Yii::$app->user->identity->tperan->kelurahan->desa.' TAHUN '.(DATE('Y')+1) : 'ANDA BUKAN USER KELURAHAN TAHUN '.(DATE('Y')+1),0,0,'C');
// $pdf->Ln();
// $pdf->Ln();
...
$pdf->MultiCell(135,5,'LAMPIRAN I :', '', 'L', 0);
$pdf->SetXY(111,10);
$pdf->SetFont('Arial','',11); 
$pdf->MultiCell(89,5,'Berita Acara Hasil Kesepakatan Musrenbang RKPD Kabupaten Simulasi di '.$model->kelurahan->desa.' Tahun '.$model->tahun, '', 'L', 0);
$y = $pdf->GetY();
$pdf->SetXY(111, $y);
$pdf->SetFont('Arial','',11); 
...
$pdf->SetXY(135, $y);
$pdf->SetFont('Arial','',11); 
$pdf->MultiCell(65,5,$model->no_ba, '', 'L', 0);
$y = $pdf->GetY();
$pdf->SetXY(111, $y);
$pdf->SetFont('Arial','',11); 
...
$pdf->SetXY(135, $y);
$pdf->SetFont('Arial','',11); 
$pdf->MultiCell(65,5,DATE('d-m-Y', strtotime($model->tanggal_ba)), '', 'L', 0);

$y = $pdf->GetY();
$pdf->SetXY(10, $y+5);
$pdf->SetFont('Arial','B',12); 
$pdf->MultiCell(180,5,'Daftar Hadir Peserta Musrenbang '.$model->kelurahan->desa, '', 'C', 0);
$y = $pdf->GetY()+5;
$pdf->SetXY(20, $y);
$pdf->SetFont('Arial','',11); 
$pdf->MultiCell(22,5,'Kelurahan', '', 'L', 0);
$pdf->SetXY(42, $y);
$pdf->SetFont('Arial','',11); 
$pdf->MultiCell(2,5,': ', '', 'L', 0);
$pdf->SetXY(44, $y);
$pdf->SetFont('Arial','',11); 
$pdf->MultiCell(65,5, $model->kelurahan->desa, '', 'L', 0);
$y = $pdf->GetY();
$pdf->SetXY(20, $y);
$pdf->SetFont('Arial','',11); 
...
$pdf->SetXY(44, $y);
$pdf->SetFont('Arial','',11); 
$pdf->MultiCell(65,5, $model->tahun, '', 'L', 0);
$pdf->Ln();
