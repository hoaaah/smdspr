        ...
        'columns' => [
            ...
            [
                ...
                'value'=> function($model){
                    if($model->status == 1){
                        return 
                        Html::a('Belum Diproses', ['praproses', 'id' => $model->id], ['class' => 'btn btn-xs btn-primary','data' => ['confirm' => 'Yakin akan memproses data?'],]).
                        Html::a('<i class="fa fa-print"></i> Cetak', ['cetak', 'id' => $model->id], ['class' => 'btn btn-xs btn-default', 'onClick' => "return !window.open(this.href, 'SPH', 'width=1024,height=768')"]);
                    }ELSE{
                        return 
                        Html::a('Telah Diproses', '#', ['class' => 'btn btn-xs btn-danger']).
                        Html::a('<i class="fa fa-print"></i> Cetak', ['cetak', 'id' => $model->id], ['class' => 'btn btn-xs btn-default', 'onClick' => "return !window.open(this.href, 'SPH', 'width=1024,height=768')"]);
                    }
                }
