...
$this->params['breadcrumbs'][] = ['label' => 'Musrenbang Kecamatan', 'url' => ['subkegiatan/']];
    ...
    <div class="col-xs-12">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Kecamatan 
                <?php
                    IF(isset(Yii::$app->user->identity->tperan->kecamatan->kecamatan)){
                        echo Yii::$app->user->identity->tperan->kecamatan->kecamatan;
                    }ELSE{
                            ...
                            [
                                ...
                                'value'=> function($model){
                                    IF($model->status_phased > 3){
                                        ...
                                        return $model->inputStatus->keterangan;    
                                    }
