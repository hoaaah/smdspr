    ...
    public function actionIndex()
    {
        ...
        */
        ...
        $dataProvider = new SqlDataProvider([
            'sql' => '
                    SELECT
                    a.kd, a.id, a.id_tahun, a.Kd_Perubahan_Rpjmd, a.Kd_Dokumen_Rpjmd, a.Kd_Usulan_Rpjmd, a.id, a.tahun, a.urusan_id, a.bidang_id, a.Nm_Bidang, a.No_Misi, a.Ur_Misi, a.no_tujuan, a.Ur_Tujuan, a.no_sasaran, a.Ur_Sasaran,
                    a.kd_progrkpd, a.id_progrkpd, a.Program, b.pagu_program_rkpd, SUM(IFNULL(b.pagu_program_renja,0)) AS pagu_program_renja, SUM(IFNULL(b.pagu_kegiatan,0)) AS pagu_kegiatan, SUM(IFNULL(b.biaya,0)) AS biaya,
                    c.pagu_program_rkpd pagu_program_rkpd_awal, SUM(IFNULL(c.pagu_program_renja,0)) AS pagu_program_renja_awal, SUM(IFNULL(c.pagu_kegiatan,0)) AS pagu_kegiatan_awal, SUM(IFNULL(c.biaya,0)) AS biaya_awal
                    ...
                    */
                    FROM
                    (
                        SELECT a.kd, a.id, a.tahun, a.urusan_id, a.bidang_id, b.Nm_Bidang, a.No_Misi, c.Ur_Misi, a.no_tujuan, d.Ur_Tujuan, a.no_sasaran, e.Ur_Sasaran,
                        a.kd_progrkpd, a.id_progrkpd, a.uraian AS Program, a.created_at, a.updated_at, a.user_id, a.input_phased, a.status, a.status_phased,
                        a.id_tahun, a.Kd_Perubahan_Rpjmd, a.Kd_Dokumen_Rpjmd, a.Kd_Usulan_Rpjmd, a.No_Misi_Rpjmd, a.No_Tujuan_Rpjmd, a.No_Sasaran_Rpjmd, a.Kd_Prog_Rpjmd, a.ID_Prog_Rpjmd
                        FROM
                        (SELECT 1 AS kd, a.* FROM t_rkpd_program a WHERE tahun = :tahun AND no_misi =98
                        UNION ALL 
                        SELECT 2 AS kd, a.* FROM t_rkpd_program a WHERE tahun = :tahun AND no_misi =99
                        UNION ALL
                        SELECT 3 AS kd, a.* FROM t_rkpd_program a WHERE tahun = :tahun AND no_misi < 98
                        ) a
                        LEFT JOIN r_bidang b ON a.urusan_id = b.kd_urusan AND a.bidang_id = b.kd_bidang
                        LEFT JOIN ta_misi_rpjmd c ON a.id_tahun = c.ID_Tahun AND a.Kd_Perubahan_Rpjmd = c.Kd_Perubahan AND a.Kd_Dokumen_Rpjmd = c.Kd_Dokumen AND a.Kd_Usulan_Rpjmd = c.Kd_Usulan AND a.No_Misi_Rpjmd = c.No_Misi
                        LEFT JOIN ta_tujuan_rpjmd d ON  a.id_tahun = d.ID_Tahun AND a.Kd_Perubahan_Rpjmd = d.Kd_Perubahan AND a.Kd_Dokumen_Rpjmd = d.Kd_Dokumen AND a.Kd_Usulan_Rpjmd = d.Kd_Usulan AND a.No_Misi_Rpjmd = d.No_Misi AND a.No_Tujuan_Rpjmd = d.No_Tujuan
                        LEFT JOIN ta_sasaran_rpjmd e ON a.id_tahun = e.ID_Tahun AND a.Kd_Perubahan_Rpjmd = e.Kd_Perubahan AND a.Kd_Dokumen_Rpjmd = e.Kd_Dokumen AND a.Kd_Usulan_Rpjmd = e.Kd_Usulan AND a.No_Misi_Rpjmd = e.No_Misi AND a.No_Tujuan_Rpjmd = e.No_Tujuan AND a.No_Sasaran_Rpjmd = e.No_Sasaran
                        ORDER BY a.kd ASC
                    ) a
                    LEFT JOIN
                    (
                        SELECT
                        /*ngecek status ajah a.status_phased, a.input_status, b.status_phased, b.status, c.status_phased, c.status, f.status_phased, f.status,*/
                        ...
                        /*WHERE a.status_phased = 6 AND a.input_status = 2 AND b.status_phased = 6 AND b.status = 2 AND c.status_phased = 6 AND c.status = 2 AND f.status_phased = 6 AND f.status = 2*/

                    )b ON a.tahun = b.tahun AND a.urusan_id = b.urusan_rkpd AND a.bidang_id = b.bidang_rkpd AND a.no_misi = b.no_misi AND a.no_tujuan = b.no_tujuan AND a.no_sasaran = b.no_sasaran AND a.kd_progrkpd = b.kd_progrkpd AND a.id_progrkpd = b.id_progrkpd
                    LEFT JOIN
                    (
                        SELECT
                        f.tahun, f.no_misi, f.no_tujuan, f.no_sasaran, f.kd_progrkpd, f.id_progrkpd, f.pagu_program AS pagu_program_rkpd, f.uraian AS program_rkpd, f.urusan_id AS urusan_rkpd, f.bidang_id AS bidang_rkpd,
                        ...
                        WHERE a.status_phased = 5 AND a.input_status = 2

                    )c ON a.tahun = c.tahun AND a.urusan_id = c.urusan_rkpd AND a.bidang_id = c.bidang_rkpd AND a.no_misi = c.no_misi AND a.no_tujuan = c.no_tujuan AND a.no_sasaran = c.no_sasaran AND a.kd_progrkpd = c.kd_progrkpd AND a.id_progrkpd = c.id_progrkpd
                    GROUP BY a.kd, a.id, a.tahun, a.urusan_id, a.bidang_id, a.Nm_Bidang, a.No_Misi, a.Ur_Misi, a.no_tujuan, a.Ur_Tujuan, a.no_sasaran, a.Ur_Sasaran,
                    a.kd_progrkpd, a.id_progrkpd, a.Program
                    ORDER BY a.kd                 
