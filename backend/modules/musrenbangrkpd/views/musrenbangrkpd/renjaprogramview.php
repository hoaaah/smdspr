      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title"><i class="fa fa-tasks"></i> Daftar Kegiatan Renja</h3>
            ...
            <div class="box-body table-responsive no-padding">
				...
				<?php echo  GridView::widget([
				        ...
				        'emptyText' => '<small><i>Tidak ada Kegiatan Renja pada Program Renja ini.</i></small>',                        
				        'columns' => [
