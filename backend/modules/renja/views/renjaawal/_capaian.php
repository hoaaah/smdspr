        ...
        'columns' => [
            [
                ...
                'value' => function ($model){
                    return $model->no_skpdMisi.'.'.$model->no_skpdTujuan.'.'.$model->no_skpdSasaran.'.'.$model->no_renjaProg.'.'.$model->no_indikator;
                }
            ],
            'tolok_ukur',
            [
                        ...
                        'update' => function ($url, $model) {
                          return Html::a('<span class="glyphicon glyphicon-pencil"></span>', $url,
                              [  
                                 ...
                                 'data-toggle'=>"modal",
                                 'data-target'=>"#myModalCapaianubah",
