...
/**
 * TaKegiatanSkpdSearch represents the model behind the search form about `common\models\TaKegiatanSkpd`.
 */
class TaKegiatanSkpdSearch extends TaKegiatanSkpd
{
    /**
     * @inheritdoc
     */
