...
/**
 * RpjmdProgramSearch represents the model behind the search form about `common\models\RpjmdProgram`.
 */
class RpjmdProgramSearch extends RpjmdProgram
{
    /**
     * @inheritdoc
     */
