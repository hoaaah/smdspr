...
<?php echo Html::a('Tambah Program', ['tambah', 'id'=>$model->ID_Tahun.'.'.$model->Kd_Perubahan.'.'.$model->Kd_Dokumen.'.'.$model->Kd_Usulan.'.'.$model->No_Misi.'.'.$model->No_Tujuan.'.'.$model->No_Sasaran],[
                                                    'data-toggle'=>"modal",
                                                    'data-target'=>"#myModal",
