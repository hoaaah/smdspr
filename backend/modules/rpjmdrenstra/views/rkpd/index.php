...
<?php echo GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                $searchModel = new \backend\modules\rkpdrenja\models\RkpdProgramSearch();
                ...
                $dataProvider->query->where('ID_Tahun = '.$model->ID_Tahun.' AND no_misi = '.$model->No_Misi.' AND no_tujuan='.$model->No_Tujuan.' AND no_sasaran='.$model->No_Sasaran);
                $dataProvider->pagination->pageParam = 'rkpd-page';
                $dataProvider->sort->sortParam = 'rkpd-sort';

                    return Yii::$app->controller->renderPartial('_rkpd', [
                        'model'=>$model,
            ...
            [
                ...
                'format' => 'raw',
                'value' => function ($model){
                    return Html::a('Proses dari RPJMD', ['create'], ['class' => 'btn btn-xs btn-primary pull-right']);
                }
            ],            
