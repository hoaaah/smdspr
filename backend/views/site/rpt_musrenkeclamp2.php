...
$pdf->MultiCell(180,5,'        Pada hari Jumat  tanggal 14 bulan Februari tahun 2014 bertempat di Aula Kantor Camat Samudera telah diselenggarakan Musrenbang Kecamatan kabupaten Aceh Utara yang dihadiri pemangku kepentingan sesuai dengan daftar hadir peserta yang tercantum dalam Lampiran I berita acara ini. ', '', 'L', 0);
$pdf->Ln();
...
$pdf->MultiCell(80,5,Yii::$app->user->identity->tperan->kd_kecamatan <> NULL ? Yii::$app->user->identity->tperan->kecamatan->kecamatan.' '.DATE('d').' '.nama_bulan(DATE('m')).' '.DATE('Y') : 'Kecamatan, '.' '.DATE('d').' '.nama_bulan(DATE('m')).' '.DATE('Y'), '', 'C', 0);
$pdf->SetY($pdf->GetY());
