 ...
 */
class RenjaKegiatanSearchf extends RenjaKegiatan
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'kd_urusan', 'kd_bidang', 'kd_unit', 'kd_sub', 'no_skpdMisi', 'no_skpdTujuan', 'no_skpdSasaran', 'no_renjaSas', 'no_renjaProg', 'id_renprog', 'id_renkeg', 'kd_bahas', 'created_at', 'updated_at', 'user_id', 'input_phased', 'status', 'status_phased'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'uraian', $this->uraian])
            ...
            ->andFilterWhere(['like', 'program.uraian', $this->id_renprog])
