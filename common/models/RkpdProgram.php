...
class RkpdProgram extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(RkpdProgramCapaian::className(), ['tahun' => 'tahun', 'no_misi' => 'no_misi' , 'no_tujuan' => 'no_tujuan', 'no_sasaran' => 'no_sasaran', 'kd_progrkpd' => 'kd_progrkpd', 'id_progrkpd' => 'id_progrkpd']);
    }
}
