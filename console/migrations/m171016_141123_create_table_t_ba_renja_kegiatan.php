...
class m171016_141123_create_table_t_ba_renja_kegiatan extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%t_ba_renja_kegiatan}}', [
        ...
        $this->addForeignKey('t_ba_renja_kegiatan_ibfk_1', '{{%t_ba_renja_kegiatan}}', 'ba_id', '{{%t_ba}}', 'id');
    }

    public function safeDown()
    {
        $this->dropTable('{{%t_ba_renja_kegiatan}}');
    }
}
