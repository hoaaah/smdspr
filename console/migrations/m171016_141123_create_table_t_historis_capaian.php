...
class m171016_141123_create_table_t_historis_capaian extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%t_historis_capaian}}', [
            ...
            'updated_at' => $this->integer(11)->comment('Menjadi tanggal perubahan'),
    ...
    {
        $this->dropTable('{{%t_historis_capaian}}');
    }
}
