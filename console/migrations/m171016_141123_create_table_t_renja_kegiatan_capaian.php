...
class m171016_141123_create_table_t_renja_kegiatan_capaian extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%t_renja_kegiatan_capaian}}', [
        ...
        $this->addForeignKey('t_renja_kegiatan_capaian_ibfk_1', '{{%t_renja_kegiatan_capaian}}', ['kd_urusan','kd_bidang','kd_unit','kd_sub'], '{{%r_sub_unit}}', ['Kd_Urusan','Kd_Bidang','Kd_Unit','Kd_Sub']);
        $this->addForeignKey('t_renja_kegiatan_capaian_ibfk_2', '{{%t_renja_kegiatan_capaian}}', 'kd_indikator_1', '{{%r_indikator_1}}', 'id');
        $this->addForeignKey('t_renja_kegiatan_capaian_ibfk_3', '{{%t_renja_kegiatan_capaian}}', 'kd_indikator_2', '{{%r_indikator_2}}', 'id');
        $this->addForeignKey('t_renja_kegiatan_capaian_ibfk_4', '{{%t_renja_kegiatan_capaian}}', 'kd_indikator_3', '{{%r_indikator_3}}', 'id');
    }

    public function safeDown()
    {
        $this->dropTable('{{%t_renja_kegiatan_capaian}}');
    }
}
