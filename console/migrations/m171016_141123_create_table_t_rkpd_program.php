...
class m171016_141123_create_table_t_rkpd_program extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%t_rkpd_program}}', [
        ...
        $this->createIndex('tahun', '{{%t_rkpd_program}}', ['tahun','urusan_id','bidang_id','no_misi','no_tujuan','no_sasaran','kd_progrkpd','id_progrkpd'], true);
    }

    public function safeDown()
    {
        $this->dropTable('{{%t_rkpd_program}}');
    }
}
