...
class m171016_141123_create_table_ta_pagu_prog_renstra extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%ta_pagu_prog_renstra}}', [
        ...
        $this->addPrimaryKey('primary_key', '{{%ta_pagu_prog_renstra}}', ['ID_Tahun','Kd_Prov','Kd_Kab_Kota','Kd_Perubahan','Kd_Dokumen','Kd_Usulan','Kd_Urusan','Kd_Bidang','Kd_Unit','No_Misi','No_Tujuan','No_Sasaran','Kd_Prog','ID_Prog']);

        $this->addForeignKey('ta_pagu_prog_renstra_ibfk_1', '{{%ta_pagu_prog_renstra}}', ['ID_Tahun','Kd_Prov','Kd_Kab_Kota','Kd_Perubahan','Kd_Dokumen','Kd_Usulan','Kd_Urusan','Kd_Bidang','Kd_Unit','No_Misi','No_Tujuan','No_Sasaran','Kd_Prog','ID_Prog'], '{{%ta_renstra}}', ['ID_Tahun','Kd_Prov','Kd_Kab_Kota','Kd_Perubahan','Kd_Dokumen','Kd_Usulan','Kd_Urusan','Kd_Bidang','Kd_Unit','No_Misi','No_Tujuan','No_Sasaran','Kd_Prog','ID_Prog']);
    }

    public function safeDown()
    {
        $this->dropTable('{{%ta_pagu_prog_renstra}}');
    }
}
