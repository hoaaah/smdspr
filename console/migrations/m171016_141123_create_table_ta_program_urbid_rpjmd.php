...
class m171016_141123_create_table_ta_program_urbid_rpjmd extends Migration
{
    public function safeUp()
    {
        ...
        $this->createTable('{{%ta_program_urbid_rpjmd}}', [
        ...
        $this->addPrimaryKey('primary_key', '{{%ta_program_urbid_rpjmd}}', ['ID_Tahun','Kd_Prov','Kd_Kab_Kota','Kd_Perubahan','Kd_Dokumen','Kd_Usulan','No_Misi','No_Tujuan','No_Sasaran','Kd_Prog','Id_Prog']);

        $this->addForeignKey('ta_program_urbid_rpjmd_ibfk_1', '{{%ta_program_urbid_rpjmd}}', ['ID_Tahun','Kd_Prov','Kd_Kab_Kota','Kd_Perubahan','Kd_Dokumen','Kd_Usulan','No_Misi','No_Tujuan','No_Sasaran','Kd_Prog','Id_Prog'], '{{%ta_program_rpjmd}}', ['ID_Tahun','Kd_Prov','Kd_Kab_Kota','Kd_Perubahan','Kd_Dokumen','Kd_Usulan','No_Misi','No_Tujuan','No_Sasaran','Kd_Prog','Id_Prog']);
    }

    public function safeDown()
    {
        $this->dropTable('{{%ta_program_urbid_rpjmd}}');
    }
}
