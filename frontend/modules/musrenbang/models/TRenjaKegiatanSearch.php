...
namespace frontend\modules\musrenbang\models;
...
/**
 * TRenjaKegiatanSearch represents the model behind the search form about `common\models\TRenjaKegiatan`.
 */
class TRenjaKegiatanSearch extends TRenjaKegiatan
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['id', 'renja_program_id', 'kd_urusan', 'kd_bidang', 'kd_unit', 'kd_sub', 'no_skpdMisi', 'no_skpdTujuan', 'no_skpdSasaran', 'no_renjaSas', 'no_renjaProg', 'id_renprog', 'id_renkeg', 'kd_asb', 'kd_bahas', 'created_at', 'updated_at', 'user_id', 'input_phased', 'status', 'status_phased'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'id' => $this->id,
            'renja_program_id' => $this->renja_program_id,
            'tahun' => $this->tahun,
