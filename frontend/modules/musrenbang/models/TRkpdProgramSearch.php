...
/**
 * TRkpdProgramSearch represents the model behind the search form about `common\models\TRkpdProgram`.
 */
class TRkpdProgramSearch extends TRkpdProgram
{
    /**
     * @inheritdoc
     */
