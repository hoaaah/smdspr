...
/**
 * TrenjaProgramSearch represents the model behind the search form about `common\models\TRenjaProgram`.
 */
class TrenjaProgramSearch extends TRenjaProgram
{
    /**
     * @inheritdoc
     */
