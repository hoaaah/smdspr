                                ...
                                'columns' => [
                                    ...
                                    [
                                        ...
                                        'value'=>function ($model, $key, $index, $widget) { 
                                            return $model->sub->Nm_Sub_Unit;
                                        },
                                        'filterType'=>GridView::FILTER_SELECT2,
                                        'filter'=>ArrayHelper::map($query, 'kd_skpd', 'Nm_Sub_Unit'), 
                                        'filterWidgetOptions'=>[
                                            'pluginOptions'=>['allowClear'=>true],
                                        ],
                                        'filterInputOptions'=>['placeholder'=>'SKPD'],
                                    ...
                                    [
                                        ...
                                        //'filter' => Arrayhelper::map($query2, 'kd_program', 'uraian'), 
                                        'filter' => \kartik\select2\Select2::widget([
                                            'model' => $searchKegiatan,
                                            'attribute' => 'id_renprog',
                                            'data' => Arrayhelper::map($query2, 'kd_program', 'uraian'),
                                        ...
                                        'value'=> function($model){
                                            return Html::a(Html::encode(strlen($model->program->uraian) >= 65 ? substr($model->program->uraian, 0,65).'....' : $model->program->uraian), ['kegiatanrinci', 'id'=>$model->id],[
                                                                    'data-toggle'=>"modal",
